...
class Pin {
  ...
  async json (p2wdbCid) {
    const result = await axios.post(`${DEFAULT_PIN_SERVER}/pin-json`, { zcid: p2wdbCid })
    ...
    // // Retrieve the data from the P2WDB.
    // const result = await this.read.getByHash(p2wdbCid)
